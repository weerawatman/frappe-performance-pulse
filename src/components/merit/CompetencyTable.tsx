              ...
              {competencyItems.map((competency) => (
                <TableRow key={competency.id}>
                  ...
                  <TableCell className="max-w-xs">
                    <p className="text-sm text-gray-600 truncate">{competency.description}</p>
                  </TableCell>
                  ...
                  <TableCell className="text-center">
                    <div className="flex flex-wrap gap-1 justify-center">
                      {competency.evaluation_levels.map((level) => (
                        <Badge
                          key={level.level}
                          variant="secondary"
                          ...
                          <div className="space-y-4">
                            <div className="bg-blue-50 p-4 rounded-lg">
                              <p className="text-sm text-blue-700">
                                <strong>รายละเอียด:</strong> {selectedCompetency.description}
                              </p>
                              <p className="text-sm text-blue-700 mt-2">
                                <strong>น้ำหนัก:</strong> {selectedCompetency.weight}%
                              </p>
                            </div>
                            <div>
                              <h4 className="font-semibold mb-3">เกณฑ์การประเมิน</h4>
                              <div className="space-y-3">
                                {selectedCompetency.evaluation_levels.map((level) => (
