  ...
  const getGuidelineContent = (cultureId: string) => {
    switch (cultureId) {
      ...
      case '2':
        return (
          <div className="text-sm space-y-1">
            <div>- การตั้งใจเรียนรู้สิ่งใหม่ๆ รวมถึงเทคโนโลยี :</div>
            <div>- นำความรู้มาใช้ปรับปรุงพัฒนาการทำงาน :</div>
            <div>- พัฒนาบริการหรือผลิตภัณฑ์ให้ดีขึ้นอย่างต่อเนื่อง :</div>
          </div>
        );
      case '3':
        return (
          <div className="text-sm space-y-1">
            <div>- เปิดรับสิ่งใหม่ :</div>
            <div>- วางแผนปรับตัว :</div>
            <div>- เตรียมความพร้อมสำหรับการเปลี่ยนแปลงอย่างรวดเร็ว :</div>
          </div>
        );
      case '4':
        return (
          <div className="text-sm space-y-1">
            <div>- ยอมรับความแตกต่าง :</div>
            <div>- เปิดใจรับฟังความคิดเห็นของทุกคนในทีม :</div>
            <div>- ร่วมกันหาแนวทางที่ดีที่สุดในการแก้ไขปัญหา :</div>
          </div>
        );
      case '5':
        return (
          <div className="text-sm space-y-1">
            <div>- ทำความเข้าใจความคาดหวังของลูกค้า (ทั้งภายในและภายนอก) :</div>
            <div>- ใส่ใจในคุณค่าของงานและบริการที่ส่งมอบให้ลูกค้า :</div>
            <div>- มุ่งเน้นการสร้างคุณค่าให้กับลูกค้าอย่างถ่องแท้ :</div>
          </div>
        );
      default:
        return null;
